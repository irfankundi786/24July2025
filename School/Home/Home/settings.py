...
SECRET_KEY = 'django-insecure-_m(o&hjo1mb9g#51-me&ns*#ml1hw=6v%9=0d=9d%j-(y2fdj2'
...
#         'NAME': 'xepdb1',  # service name or SID
#         'USER': 'scott',
#         'PASSWORD': 'tiger',
#         'HOST': '127.0.0.1',
#         'PORT': '1521',
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.oracle',
        'NAME': '127.0.0.1:1521/XEPDB1',  # <- Easy Connect using SERVICE_NAME
        'USER': 'scott',
        'PASSWORD': 'tiger',
        'HOST': '',
        'PORT': '',
