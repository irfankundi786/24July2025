...
def signup_view(request):
    if request.method == 'POST':
        ...
        return redirect('login')  # Redirect to the index or home page
...
def login_view(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if user.is_admin:
                return redirect('dashboard')  # Redirect to admin dashboard or index
                ...
                return redirect('dashboard')  # Redirect to index in case of error
